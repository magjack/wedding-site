...
export default {
    [LANGUAGE.EN]: {
        ...
        SubHeading: () => (
            <>
                The Ceremony and Dinner will be held at Chatelherault Country Park in Hamilton which is about a 20 minute drive from glasgow city centre. 
                ...
                If anyone is staying over in Glasgow there are plenty of hotel available near the piping centre
            </>
        ),
    }
}
